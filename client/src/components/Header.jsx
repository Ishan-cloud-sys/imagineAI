...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
      ...
      <button className='sm:text-lg bg-black text-white w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'>Generate Images
      ...
      <p className='mt-2 text-neutral-600'>Generated images from imagineAI</p>
    </div>
  )
}
